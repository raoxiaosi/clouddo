...
import com.bootdo.clouddoadmin.pojo.domain.UserRoleDO;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	public int resetPwd(UserDTO userDTO, UserDO userDO) throws Exception {
		if(Objects.equals(userDTO.getUserDO().getUserId(),userDO.getUserId())){
			if(Objects.equals(MD5Utils.encrypt(userDO.getUsername(), userDTO.getPwdOld()),userDO.getPassword())){
				userDO.setPassword(MD5Utils.encrypt(userDO.getUsername(), userDTO.getPwdNew()));
	...
	public int adminResetPwd(UserDTO userDTO) throws Exception {
		UserDO userDO =get(userDTO.getUserDO().getUserId());

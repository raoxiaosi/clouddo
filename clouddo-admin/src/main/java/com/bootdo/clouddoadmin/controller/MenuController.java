...
import com.bootdo.clouddoadmin.pojo.domain.MenuDO;
...
public class MenuController {
    ...
    ApiResult currentUserMenus() {
        return ApiResult.ok().put("currentUserMenus",menuService.RouterDTOsByUserId(SecuityUtils.getCurrentUser().getId()));
    }
    ...
    @PutMapping()
    ApiResult update(@RequestBody MenuDO menuDO) {
    ...
    @PostMapping
    ApiResult save(@RequestBody MenuDO menuDO) {
        return ApiResult.operate(menuService.save(menuDO) > 0);
    }
